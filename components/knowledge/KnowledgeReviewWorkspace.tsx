...
export default function KnowledgeReviewWorkspace() {
  ...
  return <section className="mx-6 mb-10 rounded-xl border bg-white p-5 lg:mx-10">
    ...
    <p className="mt-1 text-sm text-slate-500">Only explicitly approved versions create a release. An authorized admin may currently submit and approve the same version. Releases are not connected to AI retrieval.</p>
